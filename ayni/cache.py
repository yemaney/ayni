...
def set_embedding_cache(path: str = "embeddings_cache.pkl") -> dict:
    ...
    path : str, optional
        ...
        by default "embeddings_cache.pkl"
...
def cache_embedding(
    ...
    path : str, optional
        Path to the file where the embedding cache dictionary will be stored, by default "embeddings_cache.pkl"
    model : str, optional
